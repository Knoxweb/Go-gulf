...
//  SwiftProject
//
//  Created by Prabin Phasikawo on 12/11/21.
//
...
struct PhoneVerifyUIView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .modifier(
                AlertView(isPresented: $phoneVerifyVM.showAlert, primaryButtonText: .constant("Ok"), secondaryButtonText: "Ok", title: $phoneVerifyVM.alertTitle, desc: $phoneVerifyVM.alertMessage, secondaryAction: {
                    phoneVerifyVM.showAlert = false
                })
            )
