...
// SlyykDriver
//
//  Created by Office on 14/07/2022.
//
...
class BookingsDetailVM: BaseObservableObject {
    ...
    public func getBookingDetail(bookingId: String?, type: String?) {
        print(bookingId, type, "DETAILLLLLLL")
        ...
        self.loading = true
        let profileDocument = parentCollection.collection(type == "history" ? "jobs" : "my_jobs").whereField("id", isEqualTo: Int(bookingId) ?? 0)
