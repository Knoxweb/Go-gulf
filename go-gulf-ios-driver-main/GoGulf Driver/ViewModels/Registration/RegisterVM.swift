...
//  Slyyk
//
//  Created by Prabin Phasikawo on 3/10/22.
//
import SwiftUI
import Firebase
import FirebaseAuth
...
class RegisterVM: BaseObservableObject {
    ...
    public func validate(tabRouter: TabRouter) {
        ...
        createAccount(tabRouter: tabRouter)
    }
...
//                    self.showAlert.toggle()
    ...
    public func createAccount(tabRouter: TabRouter) {
