package com.gogulf.passenger.app.ui.bookinghistory.fragment.completed
...
class CompletedFragment : BaseFragment<FragmentBookingLayoutBinding>() {
...
//    private var dataList = ArrayList<Datum?>()
    ...
    override fun initView(mRootView: View?, mViewDataBinding: ViewDataBinding?) {
        ...
        bookingVM.getBookingListFromFirebase("completed")
        bookingObserver()
